...
use OpenApi\Annotations as OA;
     ...
     *     summary="List all courses (admin, teacher)",
     *     tags={"Courses"},
     *     description="Returns a paginated list of courses based on the user role. Admin sees all courses, teachers see their own.",
     *     security={{"bearerAuth":{}}},
     *
     *     @OA\Parameter(
     *         name="keyword",
     ...
     *     ),
     *     @OA\Parameter(
     *         name="level_material_id",
     *         in="query",
     *         description="Filter by level_material_id",
     *         required=false,
