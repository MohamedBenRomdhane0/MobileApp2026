...
class AssignMaterialsToSectionController extends Controller
{
    use SuccessResponse, ErrorResponse;

    public function __invoke(AssignMaterialsToSectionRequest $request, int $sectionId): JsonResponse
    {
        try {
            $section = SectionRepository::assignMaterials($sectionId, $request->validated()['material_ids'] ?? []);
