...
class AbortTeacherTrailerMultipartUploadController extends Controller
{
    ...
    public function __invoke(AbortMediaMultipartUploadRequest $request, MediaMultipartUploadService $service): JsonResponse
    {
        try {
            ...
            Log::error('Failed to abort teacher trailer multipart upload', ['error' => $exception->getMessage()]);
