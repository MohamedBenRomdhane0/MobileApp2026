...
class IndexAdminBooksController extends Controller
{
    ...
    private function getAttributes(Request $request): QueryConfig
    {
        ...
        $filters = [
            ...
            'level_section_material_id' => $request->input('level_section_material_id') ? (int) $request->input('level_section_material_id') : null,
        ];
