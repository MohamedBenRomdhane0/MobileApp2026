export const auth = {
  ...
  auto_login_warning:
    "It is recommended to open this link in a private/incognito browsing window to maintain your current session.",
  ...
  impersonation: {
    ...
    starting: "Starting...",
    success: "Impersonation started successfully",
    exit_success: "Impersonation ended successfully",
  },
};