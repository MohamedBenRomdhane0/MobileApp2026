export const home = {
  ...
  guest_label: "Guest",
  discovery_mode_title: "Discovery Mode",
  discovery_mode_subtitle: "Finish to save your child's progress",
  finish_registration: "Complete my registration",
  discovery_steps_title: "How it works",
  discovery_step_1: "Create the parent account",
  discovery_step_2: "Verify your phone number",
  discovery_step_3: "Add your child",
  discovery_step_done: "Done!",
  ...
  live_classes_title: "Live Classes",
