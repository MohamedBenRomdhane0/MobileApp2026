...
import ScanQRCodeScreen from "@screens/scan/ScanQRCodeScreen";
...
const MainTabNavigator: React.FC = () => {
  ...
  const sceneHeight = screenH - getLiquidBarReserved(insets.bottom);
  ...
  return (
    <Tab.Navigator
      ...
      screenOptions={{
        ...
        sceneStyle: { height: sceneHeight, overflow: "hidden" },
      }}
    >
      ...
      <Tab.Screen name="ScanQRCode" component={ScanQRCodeScreen} />
